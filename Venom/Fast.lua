...
video = "https://t.me/GJEGG22/2"
local list = Redis:smembers(Fast.."total")
local JABWA = "*✭ عدد مشتركين بوتك『 "..#list.." 』مشترك*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '✭ سورس زيد ✭', url = 't.me/WM_GV '},
},
{
{text = '✭ مطور الصانع ✭', url = 't.me/YP_PX '},
},
}
...
local UserId_Info = LuaTele.searchPublicChat("YP_PX")
...
local TestText = "*✯ مبرمج سورس زيد ✭\n✯ ɴᴀᴍᴇ  >* ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n*✯ ʙɪᴏ -> "..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/YP_PX"}
},
}
...
local T =[[
☆︙[𝑊𝐸𝐿𝐶𝑂𝑀𝐸 𝑇𝑂 𝑆𝑂𝑈𝑅𝐶𝐸 𝐕𝐄𝐍𝐎𝐌](t.me/WM_GV )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• مبرمج السورس •', url = 't.me/YP_PX '},
},
{
{text = '• تنصيب بوت مدفوع •', url = 't.me/YP_PX'},
},
{
{text = '• قناة التحديثات •', url = 't.me/WM_GV '},
},
{  
