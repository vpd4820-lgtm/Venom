...
chsource = Redis:get(Fast..'chsource') or "WM_GV"
devsource = Redis:get(Fast..'devsource') or "WM_GV"
function var(value)  
...
xname =  (Redis:get(Fast.."Name:Bot") or "[زيد]") 
...
msg.Name_Controller = 'المبرمج زيد ❤️‍🔥  '
...
send(msg_chat_id,msg_id,"مرحبآ بك عزيزي المبرمج زيد نورت الكروب - 🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
...
if idephoto then
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "[زيد]")
return bot.sendPhoto(msg.chat_id, msg.id, idephoto,
'\n*• اهلا 𝐕𝐄𝐍𝐎𝐌 بوت اسمي '..Bot_Name..''..
...
local caption = "اليك قائمه مطورين سورس زيد :"
...
return send(msg.chat_id, msg.id,"الرابط خطأ \nارسل الرابط بالشكل ده كمثال : https://t.me/WM_GV ", 'md', true)
end
...
if text == 'لولا' or text == 'مرات زيد' then
...
{
{text = '‹ MRAET 𝐕𝐄𝐍𝐎𝐌 › .', url = "https://t.me/merat_caser"}
},
{
{text = ' ⛥𝐕𝐄𝐍𝐎𝐌⛥ ', url = "https://t.me/WM_GV"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'زيد' or text == 'المبرمج زيد' then
photo = "https://t.me/WM_GV"
local T =[[
[ٓ  ᯓ 𓆩 ˹ †ø δølløω ძενεløρεƦ øδ †hε ՏøuƦcε ˼ 𓆪 𓆃](t.me/WM_GV )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '‹ ٰ𖣂 • BOT 𝐕𝐄𝐍𝐎𝐌 • 𖣂 ›', url = "https://t.me/caserbotbot"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '‹ ⇣ 𒅒• ᎷᏒ </> 𝙏َِ𝙊َِ𝙈ِ •𒅒 ⇣ › .', url = "https://t.me/WM_GV"}
},
{
...
keyboard.inline_keyboard = {
{
{text = '‹ ⇣ 𒅒 ⇣ › .', url = "https://t.me/WM_GV"}
},
{
{text = '‹ ٰ𖣂 • ᑕᕼ • 𖣂 ›', url = "https://t.me/WM_GV"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '' or text == 'زيد' then
photo = "https://t.me/WM_Gv"
local T =[[
...
keyboard.inline_keyboard = {
{
{text = '‹زيد › .', url = "https://t.me/WM_GV"}
},
{
{text = '‹ ٰ𖣂 • BOT ⛥⛥ • 𖣂 ›', url = "https://t.me/WM_GV150BOT"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '‹ ⇣ 𒅒• - MaZeKa El WiSkEy -𖤓̟̟̟̟̟̟̥̥̥̥̟͜͡️ •𒅒 ⇣ › .', url = "https://t.me/WM_GV"}
},
{
...
keyboard.inline_keyboard = {
{
{text = '‹ ٰ💸 ⇣ الاوامر البنكيه ⇣ 💸 › .', url = "https://t.me/GJEGGI/3"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '‹ ٰ☬ ⇣ اصنع بوتك الان ⇣ ☬ › .', url = "https://t.me/@WM_GV"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '‹ ٰ☬ ⇣ اصنع بوتك الان ⇣ ☬ › .', url = "https://t.me/YP_PX"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'المبرمج' or text == 'زيد' or text  == 'المبرمج زيد' then
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local bains = bot.getUser(msg.sender_id.user_id)
if bains.first_name then
...
bot.sendText(5986905034,0,'*\n◉  مرحباً عزيزتي لولا قلب زيد هناك \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِ𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌━━━━⩺ \n◉  اسمه :- '..klajq..' \n◉  ايديه :-  : '..msg.sender_id.user_id..'\n◉  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == "صورتي" then
...
if msg.sender_id.user_id == tonumber(6264438859) then
send(msg_chat_id,msg_id,"❍ انت زيد مطور السورس يقلبي🌚♥","md",true)
...
send(msg_chat_id,msg_id,"انتي [لولا مرات زيد] يقلبي 🥺♥","md",true)
...
{{text = '- 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌 •', url = "https://t.me/WM_GV"}},
}
}
...
return send(msg_chat_id,msg_id,'\n⌯ مرحبا بك في السجل المدني الخاص بسورس 𝐕𝐄𝐍𝐎𝐌\nاكتب اسمك الان :',"md",true)  
end
...
keyboard.inline_keyboard = {
{
{text = 'قناة السورس',url="t.me/WM_GV"}
},
}
local msg_id = msg.id/2097152/0.5
...
keyboardd.inline_keyboard = {
{
{text = 'قناة السورس', url = "https://t.me/WM_GV"}
},
}
local msg_id = msg.id/2097152/0.5
...
bot.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@WM_GV")
sleep(1)
...
{
{text = '.ˣ♡ اضغط لتنصيب بوتك ♡ˣ.', url = "https://t.me/YP_PX"}
},
{
...
if text == (Redis:get(Fast.."Name:Bot") or "زيد") then
local photo = bot.getUserProfilePhotos(Fast)
if photo.total_count > 0 then
local NamesBot = (Redis:get(Fast.."Name:Bot") or "زيد")
local Mostafa = {
'• مالك حبيبى 🥺',
...
if text == 'زيد' or text == 'مبرمج السورس' or text == 'caesar' then  
...
keyboardd.inline_keyboard = {
{
{text = '❲ المبرمج زيد ❳', url = "https://t.me/WM_GV"}
},
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌', url = "https://t.me/WM_GV"},
},
...
data = {
{
{text = '𓆩 ˹ [𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌] ˼ 𓆪', url = "https://t.me/WM_GV"}
},
}
}
bot.sendPhoto(msg.chat_id, msg.id, 'http://t.me/'..chsource..'', [[
[ٓ ˚₊· ͟͟͞͞➳❥❬ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 [𝙲𝙷] Caesar 𝚂𝙾𝚄𝚁𝙲𝙴 ❭• °](t.me/WM_GV )
]],"md", true, nil, nil, nil, nil, nil, nil, nil, nil, reply_markup)
end
if text == '/start' then
...
local Name_dev = bot.getUser(Sudo_Id).first_name
local UName_dev = bot.getUser(Sudo_Id).username
local CmdStart = '*\n🤖╖ أهلآ بك في بوت '..(Redis:get(Fast.."Name:Bot") or "[زيد]")..
...
'\n📣╢• ــــــــــــــــــــ𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌ــــــــــــــــ '..
'\n📣╢• تأكد » من تفعيل الرفع '..
